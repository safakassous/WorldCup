...
export class AddAcheteurComponent implements OnInit {
  ...
  openModal(targetModal: any) {
    ...
    let data= this.addAcheteurForm.value;
    
          this.r = Math.random().toString(36).substring(7);
       
       let body ={
         "mail_acheteur" :data.e_mail,
         "corps_mail" :"Cher client  " +data.nom +"  " +data.prenom +"  Voice votre code de confirmation de transaction :   " +this.r
         }
